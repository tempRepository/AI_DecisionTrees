...
public class Main {
    ...
    public static void main(String[] args) {
       ...
       //training set
        ...
        /*
         * trainingSet.add(new Example(false, true, null, null, null, null,
         * null, null, null, null, false)); trainingSet.add(new Example(true,
         * false, null, null, null, null, null, null, null, null, false));
         * trainingSet.add(new Example(true, true, null, null, null, null, null,
         * null, null, null, true)); trainingSet.add(new Example(false, false,
         * null, null, null, null, null, null, null, null, false));
         * 
         * attributes.add(new Alternate()); attributes.add(new Bar());
         */
        ...
        Tree.decisionTreeLearning(trainingSet, attributes,
                new ArrayList<Example>()).toString();
        System.out.println("Nowy main");
